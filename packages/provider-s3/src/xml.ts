/**
 * Minimal, dependency-free helpers for reading and writing the small subset of S3's multipart XML
 * protocol this provider needs. Deliberately not a general-purpose XML parser: S3's multipart
 * responses have a flat, predictable shape, so a full parser would be dead weight (see AGENTS.md
 * section 6: zero runtime dependencies whenever possible).
 */
